...
types = image_types + video_types + music_types + document_types
mimes = image_mimes + video_mimes + music_mimes + document_mimes
mime_ext = dict(dict(dict(image_mimes_to_ext, **video_mimes_to_ext), **music_mimes_to_ext), **document_mimes_to_ext)
