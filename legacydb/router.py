...
class LegacyRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        if model._meta.app_label == 'legacydb':
            return 'legacy'
        return 'default'
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        obj1_is_legacy = (obj1._meta.app_label == 'legacydb')
        obj2_is_legacy = (obj2._meta.app_label == 'legacydb')
        return obj1_is_legacy == obj2_is_legacy

    def allow_syncdb(self, db, model):
        return db != 'legacy' and model._meta.app_label != 'legacydb'